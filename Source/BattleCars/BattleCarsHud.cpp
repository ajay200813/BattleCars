...
ABattleCarsHud::ABattleCarsHud(const FObjectInitializer& ObjectInitializer) 
...
void ABattleCarsHud::DrawHUD()
{
	...
	if( bHMDDeviceActive == false )
	{
		...
		ABattleCarsPawn* Vehicle = Cast<ABattleCarsPawn>(GetOwningPawn());
